    ...
    <section id="hero" className="relative min-h-[550px] md:min-h-[650px] lg:min-h-[700px] px-6 md:px-12 lg:px-24 py-12 md:py-16 lg:py-20 overflow-hidden bg-background flex items-center justify-center">
      ...
      <div className="max-w-[85rem] mx-auto w-full relative">
        ...
        >
          ...
          {/* Right Side */}
          <div className="lg:col-span-6 relative w-full h-[320px] sm:h-[400px] md:h-[500px] flex items-center justify-center fade-up pointer-events-none overflow-hidden lg:overflow-visible">
            {/* Proportional Scalable Visual Canvas */}
            <div className="relative w-[500px] h-[500px] shrink-0 scale-[0.6] min-[380px]:scale-[0.7] sm:scale-[0.85] lg:scale-100 transition-transform duration-500 origin-center flex items-center justify-center">
